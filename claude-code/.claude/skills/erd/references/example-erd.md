...
* **Admin dùng chung bảng USER** với khách hàng, phân biệt bằng vai trò — không tách entity ADMIN riêng (Mermaid không có cú pháp kế thừa; xem Pitfalls — inheritance).
